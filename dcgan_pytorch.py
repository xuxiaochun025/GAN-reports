...
Original file is located at
    https://colab.research.google.com/drive/1OQqFzD0V7d8rrPLWgszhemYCBfJ_B4QV
"""
...
for epoch in range(20):
    for i,data in enumerate(train_images):
        ...
        output=netD(fake.detach()).view(-1)#detach()截断反向传播的梯度流,该节点前面的梯度不再更新
...
#                    %(epoch,10,i,len(train_images),errD.item(),errG.item(),D_x,D_G_z1,D_G_z2))
